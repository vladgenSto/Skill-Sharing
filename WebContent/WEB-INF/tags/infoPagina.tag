...
<div class="collapse" id="collapseAbout">
    <div class="card card-block">
        ...
        <p>Proteccion de datos personales:<br>
        Este sitio web se compromete a conservar sus datos ya no cederlos a terceros. Todos sus datos seran guardados
        de forma segura y solo podra acceder a ellos usted y el administrador/es de esta pagina. Las contraseñas estan cifradas
        y la pagina no se hara responsable en caso de que el usuario comparta su contraseña y se modifique algo sin su consentimiento.
        El diseño de la pagina web y su codigo fuente pertenecen a los administradores (Raul Peris Mateos y Vladimir Stoyanov Stoyanov) 
        de manera que en caso de uso de algun componente sin el consentimiento de ellos infringira la ley de propiedad intelectual.
        Ademas se reserva el derecho a realizar cambios en la pagina web e incluso cerrarla sin previo aviso.
        </p>    
	</div>
</div>
